    ...
    <div className="container">
      ...
      <style jsx>{`
        ...
        .backButton {
          ...
          border-radius: 5px;
          background: rgba(0, 0, 0, 0.3); /* Adjusted background for better visibility */
        ...
        .formGroup input:focus ~ .focus-highlight,
        .formGroup textarea:focus ~ .focus-highlight {
          opacity: 1;
        }
        ...
        .submitButton {
          margin-top: 2rem;
          position: relative;
          background: linear-gradient(135deg, #005700, #00ff00); /* Enhanced gradient */
          border: none;
          color: white;
          padding: 1.2rem 2rem;
          border-radius: 8px;
          ...
          width: 100%;
          transition: all 0.3s ease;
          box-shadow: 0 5px 25px rgba(0, 255, 0, 0.5); /* Increased shadow for better effect */
        }

        
        .submitButton:hover {
          background: linear-gradient(135deg, #00cc00, #004d00);
        ...
        .infoItem {
          padding: 1.5rem;
          border-radius: 12px;
          background: rgba(10, 10, 10, 0.8); /* Original background */
        }

        .green-tile {
          background: rgba(0, 255, 0, 0.3); /* Green transparent tile */
          border: 1px solid rgba(0, 255, 0, 0.5); /* Optional border for better visibility */
        }
        ...
        .infoItem:hover {
          ...
          box-shadow: 0 25px 60px rgba(0, 0, 0, 0.6), 0 0 40px rgba(0, 255, 0, 0.3) inset;
        }
        ...
        .infoItem:hover .info-hover-effect {
          opacity: 1;
        }
      `}</style>
    </div>
